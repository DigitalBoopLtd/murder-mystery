...
CSS_INPUT_BAR = """/* ========== RECORD BAR (inside stage) ========== */
/* Simple inline record bar - no sticky positioning needed */
#record-bar,
.record-bar {
...
/* Center the audio block and make the wrapper visually subtle */
#record-bar .block.record-audio-minimal,
.record-bar .block.record-audio-minimal {
...
#record-bar .controls .record-button,
.record-bar .controls .record-button {
    position: relative;
...
#record-bar .controls .stop-button,
#record-bar .controls .stop-button-paused,
.record-bar .controls .stop-button,
.record-bar .controls .stop-button-paused {
    position: relative;
...
/* Force hide stop button by default */
#record-bar .controls button.stop-button,
#record-bar .controls .stop-button,
.record-bar .controls button.stop-button,
.record-bar .controls .stop-button {
    display: none !important;
...
#record-bar .controls button.record-button,
#record-bar .controls .record-button,
.record-bar .controls button.record-button,
.record-bar .controls .record-button {
...
#record-bar .controls:has(.record-button[style*="display: none"]) button.stop-button,
#record-bar .controls:has(.record-button[style*="display: none"]) .stop-button,
.record-bar .controls:has(.record-button[style*="display: none"]) button.stop-button,
.record-bar .controls:has(.record-button[style*="display: none"]) .stop-button {
    display: flex !important;
    visibility: visible !important;
...
#record-bar .controls:has(.stop-button[style*="display: flex"]) .record-button,
.record-bar .controls:has(.stop-button[style*="display: flex"]) .record-button {
    display: none !important;
    visibility: hidden !important;
    opacity: 0 !important;
